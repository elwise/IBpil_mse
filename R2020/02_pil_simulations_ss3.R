...
#==============================================================================
  ...
  if (ass.sc=="none") {
    ...
    assess.ctrl[["PIL"]]$control$assess_dir <- "/home/azevedom/FLBEIA_mseIBpil/ss3R2020/"
    k<-1000
  ...
  } else if (rule.sc==2 | rule.sc==4 | rule.sc==6 | rule.sc==8) {
...
source("./R2020/fun/MP_HCR_IBpil.R")
...
out.name      <- paste("out2020_",scenario,"_catch45_",it,".RData",sep="")
out.file      <- file.path("output2020/output_iters45",out.name)
