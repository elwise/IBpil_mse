...
# we give the list of scenarios with 10000 iters by hand
scenario_list <- c("ASSss3_HCR8_REClow_INNvar_OERnaq","ASSss3_HCR9_REClow_INNvar_OERnaq",
                   "ASSnone_HCR8_REClow_INNvar_OERnone","ASSnone_HCR9_REClow_INNvar_OERnone",
                   "ASSss3_HCR10_REClowmed_INNvar_OERnaq","ASSnone_HCR10_REClowmed_INNvar_OERnone",
                   "ASSss3_HCR11_REClowmed_INNvar_OERnaq","ASSnone_HCR11_REClowmed_INNvar_OERnone")

#length(scenario_list)
# scenario_list <- "ASSnone_HCR4_REClow_INNvar_OERnone"
# scenario_list <- c("ASSss3_HCR8_REClow_INNvar_OERnaq")
...
for (cs in scenario_list){
 ...
 # tt <- c(1:42,44:834,839:1000)
  ...
  for (i in 1:ni){ #1:ni
    print(paste("     iter",i))
    if (file.exists(file.path(res.dir, "output_iters", paste("out_",cs,"_",i,".RData",sep="")))){
      load(file.path(res.dir, "output_iters", paste("out_",cs,"_",i,".RData",sep="")))
    ...
    } else stop("Missing file:", file.path(res.dir, "output_iters", paste("out_",cs,"_",i,".RData",sep="")))
  }
